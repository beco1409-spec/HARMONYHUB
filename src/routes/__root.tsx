...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // A imagem de preview (og:image/twitter:image) apontava para um bucket R2 da Lovable
      // e foi removida na migração. Adicione a sua em /public e referencie aqui, ex:
